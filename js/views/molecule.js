...
MoleculeView.initJMol = function() {
	...
	var Info = {
		...
		readyFunction: MoleculeView.ready,
	...
	/* Get Jmol canvas */
	MoleculeView.canvas = Jmol._getElement(MoleculeView.applet, "canvas2d");

	/* Get Jmol div container */
	MoleculeView.container = Jmol._getElement(MoleculeView.applet, "appletdiv");
	...
	var element = Jmol._getElement(MoleculeView.applet, "appletinfotablediv");
	element.parentNode.removeChild(element);
	element = document.getElementById("__jsmolformdiv__");
	element.parentNode.removeChild(element);
};

MoleculeView.ready = function(applet) {
};
