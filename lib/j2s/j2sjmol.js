...
xxxShowParams = function() {
  for (var i in xxxbhparams) {
    System.out.println("#P " + xxxbhparams[i] + "\t" + i);
  }
  xxxbhparams= {};
}
...
window["j2s.object.native"] = true;
 ...
 // BH 3/2/2013 9:10:45 AM optimizing defineMethod using "look no further" "@" parameter designation
 ...
 // BH 2/23/2013 found String.replaceAll does not work
...
Clazz.generateDelegatingMethod = function (claxxRef, funName, fCall) {
      ...
      //var s = claxxRef.__CLASS_NAME__ + "." + funName
      //if (s.indexOf("smarter.Atom.construct") >= 0) {alert("j2sjmol.js test gen " + arguments.callee.caller + " " + s)}
      //if (!xxBHdel[s]) {
        //xxBHdel[s] = 1
        //System.out.println("delegating " + s)
      //}
...
Clazz.defineMethod = function (clazzThis, funName, funBody, funParams) {
  ...
  // BH : funName is "hashCode", then f$ might be the JavaObject.hashCode
  
  //if (funName == "hashCode" && f$ == JavaObject.prototype.hashCode) {
    // alert ("defineMeth" + (f$.claxxOwner) + " " +  clazzThis.prototype + " " + f$.funParams + " " + fpName) 
  //}
  
	if (f$ == null
      || fpName == "\\@" 
      //|| funName == "hashCode" // BH: never a need to delegate hashCode() 
      //|| funName == "equals" && fpName == "\\Object" 
      || (f$.claxxOwner === clazzThis && f$.funParams == fpName)) {
	...
	if (f$.stacks == null 
      ...
      //}
		...
		f$ = clazzThis.prototype[funName] = Clazz
				.generateDelegatingMethod (clazzThis, funName, f$);				
...
if (finalVars!= null)
  ...
  if (finalVars != null) alert("vfinalvars=" + JSON.stringify(finalVars) + " CLAZZINNEE=" + clazzInner)
